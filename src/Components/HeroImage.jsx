  ...
  >
    <div className="w-full mt-auto flex gap-4 relative">
        ...
        <div className="text-[#D1D1D1] flex flex-col gap-4 lg:gap-6 items-start ">
            ...
            <p className='text-gray-300 text-xs w-1/2 hidden lg:block'>{wallpaper.overview.split(' ').splice(0, 20).join(' ')}...<Link  style={{zIndex: 999999999}} to={`/${wallpaper.media_type}/details/${wallpaper.id}`} className='text-[#02C39A]'>more</Link> </p>
