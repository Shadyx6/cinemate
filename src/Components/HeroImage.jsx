  ...
  >
    <div className="w-full mt-auto flex gap-4 relative">
        ...
        <div className="text-[#D1D1D1] flex flex-col gap-4 lg:gap-6 items-start ">
            ...
            <p className='text-gray-300 text-xs w-1/2 hidden lg:block'>{wallpaper.overview.split(' ').splice(0, 20).join(' ')}...<span className='text-[#02C39A]'>more</span> </p>
            <Link className='px-4 py-2 hidden text-sm bg-[#00A896] lg:block text-black rounded-lg'>Watch trailer</Link>
            <Link className="absolute bottom-5 h-14 w-14 lg:hidden bg-[#008f7e] flex items-center justify-center rounded-full right-4" to={'trailer'} >   <FaPlay size={'40%'}  fill='white' style={{ zIndex: 999999999, margin: "auto"}} /></Link>
